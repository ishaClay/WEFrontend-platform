...
const AssignCard = ({ data }: AssignListProps) => {
  const [isOpenAssignModel, setIsOpenAssignModel] = useState(false);
  const [isOpenHistoryModel, setIsOpenHistoryModel] = useState(false);
  const [isOpenDelayModel, setIsOpenDelayModel] = useState(false);
  return (
    <>
      <Modal
        open={isOpenAssignModel}
        onClose={() => setIsOpenAssignModel(false)}
      ...
      <Modal
        ...
        onClose={() => setIsOpenHistoryModel(false)}
