      ...
      <div className="border border-solid gap-1 border-[#D9D9D9] rounded-lg group flex items-end sm:justify-between justify-center xl:p-5 sm:p-4 p-0 mb-5 xl:flex-nowrap flex-wrap">
        <div className="flex sm:flex-nowrap flex-wrap sm:justify-start justify-center items-center xl:gap-5 gap-3">
          ...
          <div className="w-full sm:p-0 px-4">
            <p className="sm:text-base text-sm font-medium font-droid leading-6 mb-[10px] line-clamp-1">
              {list.course?.title}
            </p>
            <div className="flex flex-wrap md:gap-5 sm:gap-2 gap-1 pb-[10px]">
              {list?.course?.courseData?.map((item) => {
                ...
                return (
                  <Badge
                    className={`bg-[${bgColor}] text-[#3A3A3A] font-normal rounded-full font-droid text-xs leading-4 py-[4px] px-[10px] my-1 mx-[2px] hover:text-white h-auto`}
                  >
            ...
            <div className="flex items-center justify-between pb-[6px]">
              <div className="text-xl font-droid leading-6 text-[#00778B] font-bold">
                {Number(list?.course?.courseProgress).toFixed(0)}%
              </div>
              <div className="text-xs font-normal font-droid leading-4">
            ...
            <div className="flex flex-wrap items-center 2xl:gap-6 sm:gap-3 gap-2 pt-[10px]">
              ...
              <div className="flex items-center">
                ...
                <p className="text-xs font-droid font-normal text-[#3A3A3A] leading-6 pl-1">
                  ...
                  {list?.course?.isOnline === IsOnline["In-Person"] && (
                    <span>In person</span>
                  )}
        ...
        <div className="mr-0 ml-auto sm:mb-0 mb-4">
          <Button className="bg-[#00778B] text-white font-bold font-droid sm:me-0 me-4 sm:text-base text-sm rounded-md shadow py-[12px] px-[24px] h-auto">
