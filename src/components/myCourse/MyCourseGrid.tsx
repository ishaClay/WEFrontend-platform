...
const MyCourseGrid = ({ list }: myPagesListProps) => {
  return (
    <div>
      <div className="border border-solid border-[#D9D9D9] rounded-lg col-span-1 group">
        <div className="relative overflow-hidden rounded-t-lg">
          <img src={list.image} alt="" className="h-[231px] w-full" />
          <div className="absolute bottom-4 right-4 rounded-full invisible group-hover:visible">
        ...
        <div className="xl:p-5 p-4 pt-4">
          <div>
            <p className="text-base font-medium font-inter leading-6 pb-2">
              {list.title}
            </p>
          </div>
          ...
          <div className="flex flex-wrap justify-between pt-4">
            <Badge className="bg-[#FFD56A] text-[#3A3A3A] font-normal font-Poppins text-xs leading-4 py-[4px] px-[10px] my-1 mx-[2px]">
              Environmental
            </Badge>
            <Badge className="bg-[#FFD56A] text-[#3A3A3A] font-normal font-Poppins text-xs leading-4 py-[4px] px-[10px] my-1 mx-[2px]">
              Governance
            </Badge>
            <Badge className="bg-[#D6F5AC] text-[#3A3A3A] font-normal font-Poppins text-xs leading-4 py-[4px] px-[10px] my-1 mx-[2px]">
              Social
            </Badge>
          </div>
