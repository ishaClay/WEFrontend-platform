                    ...
                    >
                      <div className="flex gap-3 items-center">
                        ...
                        <div className="relative">
                          ...
                          {data?.count > 0 && (
                            <span className="absolute bottom-2 right-0 text-[14px] flex items-center justify-center font-abhaya font-semibold bg-[#76BC41] w-4 h-4 rounded-full text-white">
                              {data?.count}
                            </span>
                          )}
                        </div>
