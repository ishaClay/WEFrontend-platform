        ...
        <header className="  bg-[#FAFAFA] h-[120px] w-[1304px]  ">
            ...
            <div className="  text-[#3A3A3A] font-[calibri] ">
                <ul className="flex  font-[400px] text-[16px] gap-8 ">
                    <li className="mt-[48px] ml-[20px]"><RxHamburgerMenu className="w-8 h-8" /></li>
                    ...
                    <li className="group flex  gap-[5px] mt-[50px]">
                        ...
                        <img className="w-[6px] h-[6px] mt-3" src="../assets/img/Vector 1.png" alt="Vector 1" />
                    </li>
                    ...
                    <li className="ml-[10px] mt-[14px]"><img className="  w-[136px] h-[105px]" src="../assets/img/logo2.png" alt="Logo 2" /></li>
                </ul>
            </div>
