  ...
  return (
    <div className="grid grid-cols-9 bg-white sm:p-5 p-[15px] rounded-lg sm:gap-5 gap-[15px]">
      <div className="xl:col-span-4 col-span-9">
        <div className="flex shadow rounded-lg border border-[#dddddd33] sm:p-5 p-[15px]">
          ...
          <div className="sm:pl-[15px] pl-[10px]">
            <h5 className="sm:text-lg text-sm font-semibold font-inter leading-[22px]">
              Emilla Anderson
            </h5>
            ...
            <div className="flex items-center sm:text-sm text-xs font-normal font-inter leading-4 sm:pt-5 pt-[10px]">
              <p>Started : </p>
      ...
      <div className="xl:col-span-5 col-span-9 ml-auto mr-0 w-full">
        <div className="md:h-[400px] sm:h-[350px] h-[200px] flex justify-center items-center bg-[#F5F5F5] rounded-lg">
          <img
            src={frameImage}
            alt=""
