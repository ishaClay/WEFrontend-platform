...
const TrainingProviders = () => {
  ...
  return (
    <div className="bg-[#F7F8FC] py-10">
      ...
      >
        <h6 className="md:text-4xl sm:text-3xl text-2xl font-droid font-semibold text-center sm:pb-14 pb-[30px]">
        ...
        {/* <div className="w-[250px] h-[47px] button-color rounded-[6px] flex justify-center items-center mb-[44px]">
          <p className="font-extrabold xl:text-2xl text-xl leading-5 traking-[-4%] text-color font-font-droid">
            For Training Providers
          </p>
        </div>
        <h3 className="font-bold md:text-2xl sm:text-xl text-lg font-font-droid sm:leading-7 leading-5">
          Get your training to those it’ll help
        </h3> */}
