            ...
            <div className="flex items-center">
              <div className="md:w-20 w-10 md:h-20 h-10 rounded-full bg-[#F5F7FF] flex justify-center items-center">
                <img
                  src={data.image}
                  alt=""
                  className="md:w-9 w-7 h-7 md:h-9"
                />
              </div>
              <div className="ps-5">
                <span className="font-bold font-droid lg:text-[32px] text-lg text-black">
                  {data.title}
                </span>
                <h5 className="sm:text-base text-sm font-droid text-black sm:block hidden">
                  {data.subTitle}
                </h5>
              </div>
            </div>
            <h5 className="sm:text-base text-sm font-droid text-black sm:hidden block pt-2">
              {data.subTitle}
            </h5>
          </>
        )}
