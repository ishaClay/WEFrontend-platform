...
function TeaserScoreHeader() {
    ...
    return (
        <header className="max-container flex">
            <div className="2xl:ml-[167px] ml-[50px] mt-[57px]">
            ...
            <div className="mt-[106px] ml-[22px] text-[#3A3A3A] font-[calibri]">
                <ul className="flex gap-[31px] font-[400] text-[16px] leading-[19.53px]">
                    <li className="group flex items-center gap-[5px]">
                        ...
                        <img className="w-[6px] h-[6px]" src="../assets/img/Vector 1.png" alt="Vector 1" />
                    </li>
                    <li>Testimonial</li>
                    <li>Blogs</li>
                    <li>Contact Us</li>
            ...
            <div className="mt-[94px] xl:ml-[385px] ml-[100px] text-[14px] flex items-center space-x-2 relative">
            ...
            <img className="ml-[31px] mt-[42px] w-[136px] h-[105px]" src="../assets/img/logo2.png" alt="Logo 2" />
        </header>
    );
}
