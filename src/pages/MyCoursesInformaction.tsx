...
function MyCoursesInformaction() {
        ...
        <div className="p-4">
          <div className="pb-4 w-full lg:w-[1195px] h-[50px] bg-[#FFFFFF] border-b border-[#F1F1F1] rounded-t-[10px] flex items-center justify-between">
            <div className="flex items-center">
              ...
              <span className="text-[18px] font-semibold ml-1">My Courses</span>
            </div>
          ...
          <div className="">
            {activeTab === "tab1" && (
              <div className="w-full mx-auto mt-4 ml-4">
                <div className="mb-8">
                  <h2 className="text-xl font-semibold mb-2">The standard Lorem Ipsum passage, used since the 1500s</h2>
...
export default MyCoursesInformaction