          ...
          <div className="">
            {activeTab === 'tab1' &&
              <div className="w-full mx-auto mt-4 ml-4">
                ...
                <div className=" flex">
                  <div className="w-[268px] h-[140px] rounded-[5.06px] flex items-center   ">
                ...
                <div className=" mt-16 ml-[875px] bg-white shadow-md rounded-lg p-2 flex items-center border border-[#D9D9D9] h-[70px] w-[332px]">
