                    ...
                    <div className="flex flex-col justify-between mt-4">
                        <div>
                            ...
                            <div className="flex items-center mt-2 mr-2">
                                ...
                                <div className="text-[12px] ml-auto md:ml-[490px]">1 of 5 Completed</div>
                            </div>
                    ...
                    <div className="flex flex-col justify-between mt-4 ">
                        <div>
                            ...
                            <div className="flex items-center mt-2">
                                <div className="text-[20px] text-[#00778B] font-bold">{100}%</div>
                                <div className="text-[12px] ml-auto ml-[490px]">1 of 5 Completed</div>
                            </div>
                    ...
                    <div className="flex flex-col justify-between mt-4">
                        <div>
                            ...
                            <div className="flex items-center mt-2">
                                ...
                                <div className="text-[12px] ml-auto ml-[493px]">1 of 5 Completed</div>
                            </div>
                            <div className="w-full md:w-[640px] h-[8px] bg-[#E8E8E8] rounded-lg mt-2">
                                <div
                                    className="h-[8px] bg-[#00778B] text-white rounded-lg text-[10px] text-center"
