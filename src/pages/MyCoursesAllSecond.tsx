...
function MyCoursesAllSecond() {
    ...
    return (
        <div className="flex bg-[#EDEFF9] w-[1510px] h-[1590px]  overflow-hidden">
            ...
            <div className="bg-[#FFFFFF] w-[1230px] h-[1540px] mt-[20px] ml-[20px] rounded-[10px]  ">
                <div className="p-4">
                ...
                <div className="ml-[20px] mt-[20px] h-[195px] w-[1190px] border border-solid border-[#D9D9D9] rounded flex">
                    ...
                    <div className="flex flex-col justify-between ">
                        <div>
                            ...
                            <div className="w-[640px] h-[8px] bg-[#E8E8E8] rounded-lg mt-2">
                                <div className="h-[8px] bg-[#00778B] text-white rounded-lg text-[10px] text-center"
                                    style={{ width: `${30}%` }}>
                                </div>
                            </div>
                    ...
                    <div className="rounded-full py-1 px-2 mb-4 ml-[110px] mt-[120px]  ">
                ...
                <div className="ml-[20px] mt-[20px] h-[195px] w-[1190px] border border-solid border-[#D9D9D9] rounded flex">
                    ...
                    <div className="flex flex-col justify-between ">
                        <div>
                            ...
                            <div className="flex items-center mt-2">
                                ...
                                <div className="text-[12px] ml-[495px]">
                                    1 of 5 Completed
                                </div>
                    ...
                    <div className="rounded-full py-1 px-2 mb-4 ml-[80px] mt-[120px]  ">
                ...
                <div className="ml-[20px] mt-[20px] h-[195px] w-[1190px] border border-solid border-[#D9D9D9] rounded flex">
                    ...
                    <div className="flex flex-col justify-between ">
                        <div>
                            ...
                            <div className="flex gap-6 mt-3">
                                <button className="bg-[#EDF0F4] text-[#3A3A3A] rounded-full h-[28px] w-[110px]">Environment</button>
                                <button className="bg-[#FFD56A] text-[#3A3A3A] rounded-full h-[28px] w-[95px]">Governance</button>
                                <button className="bg-[#FF5252] text-[#3A3A3A] rounded-full h-[28px] w-[90px]">Introductory</button>
                            </div>
