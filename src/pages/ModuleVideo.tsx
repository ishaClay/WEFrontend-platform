                    ...
                    <div className="">
                        ...
                        {activeTab === 'tab2' &&
                            ...
                            <div>
                                ...
                                <div className="  m-4 w-[1170px] font-Inter text-[16px] ">
                                ...
                                <div className=" absolute right-0 top-[1225px] bottom-0 left-[1165px] bg-white shadow-md rounded-lg p-2 flex items-center border border-[#D9D9D9] h-[70px] w-[332px]">
