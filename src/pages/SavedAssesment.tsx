    ...
    <>
      <div>
        ...
        <div className="mainContailner">
          <div className="flex">
            <div className="mt-[20px] bg-[#F6F6F6] ">
              <img
            ...
            <div className="max-w-[720px] relative mt-[142px] ml-[40px]">
              ...
              <div className="pt-8 pl-[px] pb-5 max-w-[800px] flex flex-wrap gap-5">
              ...
              <Button
                ...
                className="bg-[#64A70B] text-[20pxpx] leading-5 w-[180px] my-[20px]"
              >
                Continue Assessment
              </Button>
            </div>
