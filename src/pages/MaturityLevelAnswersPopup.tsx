                ...
                <div className="flex">
                    <div className="h-[105px] w-[270px] flex flex-col">
                        <div className="flex ">
                            ...
                            <div className="ml-2 mt-2 h-[25px] w-[203px]">
                                <h2 className="text-xm font-bold text-[#1D2026] font-calibri text-lg font-semibold">
                        ...
                        <div className="h-[19px] w-[270px]  flex mt-[35px]">
                            <div className="h-[19px] w-[86px] flex">
                                ...
                                <div className="h-[19px] w-[62.21px] text-xs ml-[10px]">Introductory</div>
                            </div>


                            <div className="h-[19px] w-[86px] flex ml-[12px]">
                                <div className="h-[12px] w-[12px] rounded  bg-[#FFD56A] mt-[3px] "></div>
                                <div className="h-[19px] w-[65px] text-xs ml-[10px]">Intermediate</div>
                            </div>
                            <div className="h-[19px] w-[86px] flex ml-[12px]">
                                <div className="h-[12px] w-[12px] rounded  bg-[#64A70B] mt-[3px] "></div>
                                <div className="h-[19px] w-[49px] text-xs ml-[10px]">Advanced</div>
                            </div>
                    ...
                    <div className="h-[105px] w-[270px] ">
                        ...
                        <div className="ml-3 mt-2 h-[25px] w-[230px]">
                            <h2 className=" text-xm font-bold text-[#1D2026] font-calibri text-lg font-semibold">Maturity level of your answers</h2>
                        </div>
                ...
                <div className="flex  flex-col mt-6">
                    ...
                    <div className='flex gap-2'>
                        <div className="flex flex-col border p-3 rounded-lg w-[252px] h-[150px]">
                            ...
                            <div className="text-xs mb-3 mt-2 h-[75px] w-[230px]  font-calibri text-sm font-normal leading-[17.4px] text-left">
                            ...
                            <div className="overflow-hidden h-6 mb-1 text-xs flex rounded-full bg-[#EDF0F4]">
                                <div style={{ width: `${progress}%` }} className="rounded-full bg-[#64A70B]"></div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col border p-3 rounded-lg w-[252px] h-[150px]">
                            ...
                            <div className="overflow-hidden h-4 mb-1 text-xs flex rounded-full bg-[#EDF0F4]">
                                <div style={{ width: `${progress1}%` }} className="rounded-full bg-[#F63636]"></div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col border p-3 rounded-lg w-[252px] h-[150px]">
                            ...
                            <div className="overflow-hidden h-6 mb-1 text-xs flex rounded-full bg-[#EDF0F4]">
                                <div style={{ width: `${progress2}%` }} className="rounded-full bg-[#FFD56A]"></div>
                            </div>
                        </div>
                    ...
                    <div className='flex gap-2 mt-[6px] h-[150px] w-[508px]'>
                        ...
                        <div className="flex flex-col border p-3 rounded-lg w-[252px] h-[150px]">
                            ...
                            <div className="overflow-hidden h-4 mb-1 text-xs flex rounded-full bg-[#EDF0F4]">
                                <div style={{ width: `${progress3}%` }} className="rounded-full bg-[#F63636]"></div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col border p-3 rounded-lg w-[252px] h-[150px]">
                            ...
                            <div className="overflow-hidden h-6 mb-1 text-xs flex rounded-full bg-[#EDF0F4]">
                                <div style={{ width: `${progress4}%` }} className="rounded-full bg-[#F63636]"></div>
                            </div>
                        </div>
                    ...
                    <div className="flex">
                        <button className="bg-green-500 text-white px-2 py-1 rounded-md text-sm w-[119px] h-[48px] ml-[650px] mt-4">Close</button>
