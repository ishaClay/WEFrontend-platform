                ...
                <div className="flex flex-col md:flex-row">
                    <div className=" md:w-[325px] h-[655px] border-r border-[#D9D9D9]">
                        <div className=" md:w-[325px] h-[60px] border-b border-[#D9D9D9]">
                            <div className="relative mt-4 m-2 ml-3">
                                <input
                                    ...
                                    className="pl-10 pr-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:border-[#D9D9D9] w-full md:w-[298px] placeholder-[#D9D9D9]"
                                />
                        ...
                        <div className=" md:w-[320px] h-[90px] bg-[#FFFFFF] hover:bg-[#EDEFF9] hover:text-black p-2 cursor-pointer">
                            <div className="flex">
                                <div>
                                    <div className="h-[42px] w-[43px] rounded-full bg-[#0E9CFF] flex items-center justify-center mr-4 mt-2 text-white">LR</div>
                                </div>
                                <div className="flex flex-col">
                                    <div className="flex">
                                        <div className="text-[16px] font-semibold">Honey Risher</div>
                                        <div className="text-gray-600 text-xs ml-auto">11:57 AM</div>
                                    </div>
                                    <div className="flex flex-col">
                                        <div className="text-xs text-[#A3A3A3]">company</div>
                                        <div className="text-sm overflow-hidden  md:w-[226px] whitespace-nowrap overflow-ellipsis mt-1">Inquiry Subject Sample — Regarding Inquiry Subject Sample</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className=" md:w-[320px] h-[90px] bg-[#FFFFFF] hover:bg-[#EDEFF9] hover:text-black p-2 cursor-pointer">
                            <div className="flex">
                                <div>
                                    <div className="h-[42px] w-[43px] rounded-full bg-[#0077A2] flex items-center justify-center mr-4 mt-2 text-white">HR</div>
                                </div>
                                <div className="flex flex-col">
                                    <div className="flex">
                                        <div className="text-[16px] font-semibold">Honey Risher</div>
                        ...
                        <div className="md:w-[320px] h-[90px] bg-[#FFFFFF] hover:bg-[#EDEFF9] hover:text-black p-2 cursor-pointer">
                            <div className="flex">
                                <div>
                                    <div className="h-[42px] w-[43px] rounded-full bg-[#64A70B] flex items-center justify-center mr-4 mt-2 text-white">CR</div>
                                </div>
                                <div className="flex flex-col">
                                    <div className="flex">
                                        <div className="text-[16px] font-semibold">Honey Risher</div>
                        ...
                        <div className="md:w-[320px] h-[90px] bg-[#FFFFFF] hover:bg-[#EDEFF9] hover:text-black p-2 cursor-pointer">
                            <div className="flex">
                                <div>
                                    <div className="h-[42px] w-[43px] rounded-full bg-[#1FA8DC] flex items-center justify-center mr-4 mt-2 text-white">EJ</div>
                                </div>
                                <div className="flex flex-col">
                                    <div className="flex">
                                        <div className="text-[16px] font-semibold">Honey Risher</div>
                        ...
                        <div className="md:w-[320px] h-[90px] bg-[#FFFFFF] hover:bg-[#EDEFF9] hover:text-black p-2 cursor-pointer">
                            <div className="flex">
                                <div>
                                    <div className="h-[42px] w-[43px] rounded-full bg-[#FD9372] flex items-center justify-center mr-4 mt-2 text-white">JD</div>
                                </div>
                                <div className="flex flex-col">
                                    <div className="flex">
                                        <div className="text-[16px] font-semibold">Honey Risher</div>
                        ...
                        <div className=" md:w-[320px] h-[90px] bg-[#FFFFFF] hover:bg-[#EDEFF9] hover:text-black p-2 cursor-pointer">
                            <div className="flex">
                                <div>
                                    <div className="h-[42px] w-[43px] rounded-full bg-[#A81F58] flex items-center justify-center mr-4 mt-2 text-white">LR</div>
                                </div>
                                <div className="flex flex-col">
                                    <div className="flex">
                                        <div className="text-[16px] font-semibold">Honey Risher</div>
                        ...
                        <div>
                            <ScrollArea className="md:h-[380px] rounded-md p-4">
                                ...
                                <div className="md:h-[170px]">
                                    ...
                                    <div className="md:h-[100px]  ml-12 mt-2 bg-[#FFFFFF] md:w-[800px]">
                                        <div className="md:h-[100px]  md:w-[780px] text-[16px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit.</div>
                                    </div>
                                    <div className="flex items-center">
                                        <div className="border-t border-[#D9D9D9] flex-grow"></div>
                                        <div className="mx-4 text-[#D9D9D9]">22 March 2024</div>
