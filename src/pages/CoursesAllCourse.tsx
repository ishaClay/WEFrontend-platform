                    ...
                    <div className="flex justify-center h-full">
                      ...
                      >
                        ...
                        <div className=" flex border-t py-[15px] pr-[10px] pl-[6px] justify-between">
                          <div className="">
                            <p className="text-black mb-1 text-xs"><span className="font-medium">Cohort 2 :</span> <span>Start</span>
                              <span className="p-[5px] rounded-full text-[10px] bg-[#D6F5AC] mx-1 inline-block">22/5/2024</span> to
                              <span className="p-[5px] rounded-full text-[10px] bg-[#D6F5AC] mx-1 inline-block">30/5/2024</span>
                            </p>
                            <p className="text-[#4285F4] text-xs font-medium">Show all cohort</p>
                          </div>
                          <div>
                            <button onClick={() => handleEnroll(allcourse?.id)} 
