                ...
                <div className="bg-[#FFFFFF] w-[1250px] h-[1469px] m-[12px] rounded-t-[10px]">
                    ...
                    <div className="ml-[20px] mt-[20px] h-[500px] w-[356px] border border-solid border-[#D9D9D9] rounded">
                        ...
                        <div className="  overflow-hidden rounded">
                            <img className=" w-[356px] h-[231px] rounded object-cover object-center " src="/public/assets/img/nature.png" alt="Course" />
                        </div>
                        <div className="h-[66px] w-[300px] mt-[5px] ml-[15px]" >
                            <p className="text-[16px] font-semibold">Certificate in the Sustainable Development Goals, Partnership, People, Planet and Prosperity</p>
                        </div>
                        ...
                        <div className="flex mt-[10px]">
                            ...
                            <p className='ml-[10px] text-[#918A8A]'>
                                <img className="inline-block ml-1 w-[18px] h-[24px] mr-[10px] " src="/public/assets/img/abc.png" alt="Image Alt Text" />
                                Social
                            </p>
