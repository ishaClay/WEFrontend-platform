        ...
        <div className="flex bg-[#EDEFF9] w-[1510px] h-[730px]  overflow-hidden">
            ...
            <div className="bg-[#FFFFFF] w-[1230px] h-[690px] mt-[20px] ml-[20px] rounded-[10px]  ">
                ...
                <div className="flex gap-6 ml-6">
                    <div className="w-[510px] h-[205px] border rounded-[10px] border-[#D9D9D9] shadow-sm flex ">
                        <div className="flex">
                            <div className="overflow-hidden rounded mt-4 ml-4 w-[100px]">
                                <img className="w-[100px] h-[100px] rounded-[10px] object-cover object-center"
                                    src="/public/assets/img/face1.jpg" alt="Course"
                                />
                            </div>
                            <div className="flex flex-col w-[330px] gap-2 mt-4 ml-2 ">
                                <div className="text-[18px] font-semibold">
                                    Emilla Anderson
                                </div>
                                <h2 className="text-[14px] ">Certificate in the Sustainable Development Goals, Partnership, People, Planet and Prosperity</h2>
                                <div>
                                ...
                                <div>
                                    Sustainability Level : <span className="font-semibold">Intermediate</span>
                                </div>
                            </div>
                    ...
                    <div className=" bg-[#00000010] w-[640px] h-[410px] rounded-[10px]  shadow-sm  flex items-center justify-center">
                        <RxImage className="h-[60px] w-[60px] text-[#ACACAC]" />
                    </div>

                </div>

                <div className="ml-[970px]">
                    <button className="m-5 px-4 py-2 bg-[#00778B] text-white rounded-[5px] w-[203px] h-[40px] ">Download certificate</button>
                </div>
