                ...
                <div className="mt-4">
                    ...
                    <div className="">
                        ...
                        {activeTab === 'tab2' &&
                            ...
                            <div className="m-4">
                                <div className="w-[1200px] h-[100px] bg-[#F1F1F1] flex border border-[#D9D9D9] rounded-md">
                                    <div className="flex items-center ">
                                        <VscFilePdf className="h-[50px] w-[35px] mr-4 text-[#D9D9D9] ml-4" />
                                        <div>
                                            <h1 className=" font-semibold text-[#000000] text-[16px]">Doug's Story 3.pdf</h1>
                                            <p className=" text-[#A3A3A3]  text-[16px]">PDF File</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <h1 className="text-[20px] font-semibold text-[#000000] mt-2">Doug's Story 3</h1>
                                <div className="flex justify-between items-center mt-4 bg-white">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        />
                                        <div className="ml-2">
                                            <div className="text-[16px] font-medium text-gray-700">Devon Lane</div>
                                            <div className="flex items-center space-x-1">
                                                <p className="text-[16px] text-[#A3A3A3]">Rating 4/5</p>
                                                <MdOutlineStar className="text-[#FFA25E]" />
                                                <span className="text-[16px] text-[#A3A3A3]">• 100 Views</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex space-x-4">
                                        <button className="p-2 border border-gray-300 rounded h-[42px] w-[110px] flex items-center justify-center space-x-2">
                                            <MdOutlineMessage className="h-[22px] w-[22px]" />
                                            <span className="text-[12px]">Feedback</span>
                                        </button>
                                        <button className="p-2 border border-gray-300 rounded h-[42px] w-[150px] flex items-center justify-center space-x-2">
                                ...
                                <div className=" mt-8 w-[1170px] font-Inter text-[16px] ">
                                ...
                                <div className=" mt-16 ml-[500px]">
                                    <button className="bg-[#00778B] text-white rounded-md text-sm h-[37px] w-[137px]">
                                        Mark as Complete
                                    </button>
                                </div>

                                <div className=" absolute right-0 top-[690px] bottom-0 left-[1165px] bg-white shadow-md rounded-lg p-2 flex items-center border border-[#D9D9D9] h-[70px] w-[332px]">
