                ...
                <div className="w-[1204px] h-[120px] ">
                    ...
                    <div className="flex flex-col gap-4 p-4 border w-[1210px] ml-[20px] mt-[10px] rounded">
                        ...
                        <div className="flex items-center mt-[20px]">
                            ...
                            <div className="ml-[20px]">
                                <button className="bg-[#00778B] text-white px-3 py-1 rounded">DOWNLOAD</button>
                 ...
                 <div className="flex flex-col gap-4 p-4 border w-[1210px] ml-[20px] mt-[10px] rounded">
                    <div className="flex p-1">
                            <img src="/public/assets/img/face1.jpg" alt="Employee Name" className="w-[32px] h-[32px] rounded-full mr-4 " />
                            <div className="flex flex-col">
                                <span className="text-[16px]  text-[#000000]">Support Person Name</span>

                                <span className="text-[12px] text-[#A3A3A3]  ">Reply By: Replied Type</span>
                            </div>
                        </div>
                        <div className="text-[16px] font-semibold text-[#A3A3A3]">Ticket Details</div>
                        <div className="text-black text-[16px]">
