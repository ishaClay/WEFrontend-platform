	...
	return (
		<div className="flex bg-[#f5f3ff] w-[1510px] h-[1210px] overflow-hidden">
			...
			<div className="flex flex-col  ">
				...
				<div className="bg-[#FFFFFF] w-[1250px] h-[1200px] m-[12px] rounded-t-[10px]">
					...
					<div className="flex justify-between">
						...
						<div className="flex flex-col mb-4 ml-8">
							<div className="flex mt-8 ml-2 gap-2 ">
								...
								<div className=" text-xs text-[#58BA66] font-semibold py-2 h-[25px] w-[71px] px-4 rounded-full mr-2 flex items-center justify-center">
									Answered
								</div>
