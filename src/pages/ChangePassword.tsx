...
function ChangePassword() {
    ...
    return (
        <div className="fixed inset-0 flex justify-center items-center">
            <Card className="bg-white rounded-lg  h-[467px] w-[610px] ">
                <div className=' ml-4 mt-3 text-[20px] font-semibold'>
                    <h1>Settings</h1>
                </div>
                <div className='flex'>
                    <div className=" w-[200px] h-[380px] flex flex-col m-4 gap-4 border-r-2 border-[#E4E4E4]">

                        <button className="bg-[#F5F5F5] w-[170px] h-[40px] text-[#606060] px-6 py-2 hover:bg-[#00778B] hover:text-white rounded-md">
                            Profile Setting
                        </button>
                        <button className="bg-[#F5F5F5] w-[170px] h-[40px] text-[#606060] px-6 py-2 hover:bg-[#00778B] hover:text-white rounded-md">
                            Account Setting
                    ...
                    <div className=''>
                        ...
                        <div className="max-w-md mx-auto border-b-2 pb-4 border-[#E4E4E4] mt-2">
                            <div className="mb-4">
                                ...
                                <input
                                    id="old-password"
                                    type="password"
                                    className="appearance-none block w-[360px] border border-[#D9D9D9] rounded-md py-2 px-3 "
                            ...
                            <div className="flex ml-[145px] space-x-4 ">
                        ...
                        <div className="flex items-center mt-4">
                            ...
                            <div
                                className={`relative inline-flex h-6 w-11 items-center rounded-full cursor-pointer transition-colors duration-300 ml-[200px] ${enabled ? 'bg-[#00778B]' : 'bg-gray-200'
                                    }`}
