...
function MyCoursesAll() {
    ...
    return (
        <div className="flex flex-col md:flex-row bg-[#EDEFF9] w-full md:w-[1510px] h-full md:h-[1250px] overflow-hidden relative">
            {sidebarOpen && (
            ...
            <div className="bg-[#FFFFFF] w-full lg:w-[1230px] h-auto lg:h-[1210px] mt-[20px] lg:ml-[20px] rounded-[10px] ">
                <div className="p-4">
                    <div className="pb-4 w-full lg:w-[1195px] h-[50px] bg-[#FFFFFF] border-b border-[#F1F1F1] rounded-t-[10px] flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <span className="text-[24px] font-semibold ml-2">My Courses</span>
                        </div>
                ...
                <div className="flex flex-wrap justify-center md:justify-start ml-1">
                            ...
                            <div className="relative overflow-hidden rounded">
                                ...
                                <div className="flex items-center absolute bottom-0 left-[75%] transform -translate-x-1/2 rounded-full py-1 px-2 mb-4">
                                    <button className="bg-[#00778B] text-white font-medium py-2 px-4 rounded-lg shadow h-[50px] w-[150px]">
                                        {(index === 1 || index === 4) ? 'View Certificate' : 'Continue'}
                                    </button>
                                </div>
                            </div>
                            <div className="w-[90%] mt-[5px] mx-auto">
                                <p className="text-[16px] font-semibold">
                                    Certificate in the Sustainable...
                                </p>
                            </div>
                            <div className="flex mt-2 mx-auto w-[90%]">
                                <div className="text-[20px] text-[#00778B] font-bold">
                                    {(index === 1 || index === 4) ? 100 : 25}%
                                </div>
                                <div className="text-[12px] ml-auto mt-2">
                                    1 of 5 Completed
                                </div>
                            </div>
                            <div className="w-[90%] h-[8px] bg-[#E8E8E8] rounded-lg mx-auto mt-2">
                                <div
                                    className="h-[8px] bg-[#00778B] text-white rounded-lg text-[10px] text-center"
                                    style={{ width: `${(index === 1 || index === 4) ? 100 : 25}%` }}
                                ></div>
                            </div>
