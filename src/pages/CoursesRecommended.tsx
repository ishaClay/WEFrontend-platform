                        ...
                        <div className="w-[1226px] h-[175px] bg-[#FFFFFF] flex  border border-[#D9D9D9] m-[12px] rounded-md shadow-sm">
                            ...
                            <div>
                                <div className="flex flex-col ">
                                    ...
                                    <button onClick={() => navigate('/compose')} className=" h-[42px] w-[110px] bg-[#00778B] text-white ml-[100px] mt-[7px] font-semibold px-4 py-2 rounded hover:bg-gray-400 focus:outline-none focus:bg-gray-400">Inquire</button>
                                </div>
                            </div>
                        </div>
                    </div>
