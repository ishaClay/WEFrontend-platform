            ...
            <div className="flex flex-col  ">
                ...
                <div className="bg-[#FFFFFF] w-[1250px] h-[1469px] m-[12px] rounded-t-[10px]">
                    <div className="  pt-[16px] pl-[30px] w-[1250px] h-[60px] bg-[#FFFFFF] border-b border-[#D9D9D9] rounded-t-[50px] flex items-center justify-between">
                        ...
                        <button className="bg-[#00778B] text-white px-4 py-2 rounded mr-[20px] mb-[13px] h-[45px] w-[150px]" >Send Invitation</button>
                    </div>
                        ...
                        <table className="table-auto w-full   ">
                            <thead>
                                <tr className="bg-[#F1F1F1] h-[50px]">
                                    ...
                                    <th className=" "><span className="flex ml-4">Team Member<span className="mt-1"><TbSelector /></span></span></th>
                                    <th className=" "><span className="flex ml-4">Edit Action Item<span className="mt-1"><TbSelector /></span></span></th>
                                    <th className=" "><span className="flex ml-4">Retake Self-assessment<span className="mt-1"><TbSelector /></span></span></th>
                                    <th className=" "><span className="flex ml-4">Share Feedback<span className="mt-1"><TbSelector /></span></span></th>
                            ...
                            <tbody >
                                {employeeData.map(employee => (
                                    <tr key={employee.id} >
                                        <td className=" border-b px-30 pl-4 py-2"><span className="w-[110px]">{employee.id}</span></td>
                                        <td className=" border-b px-30 py-4 "><span className="flex">    <img src="public/assets/img/face1.jpg" alt="Employee" className="w-8 h-8 rounded-full mr-2" />
                                            {employee.name}</span>
                                            {/* //https://via.placeholder.com/50 */}
                                        </td>
                                        <td className=" border-b px-30 pl-4 py-2 "> <Switch /> </td>
