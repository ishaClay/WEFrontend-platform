...
function EmployeeSupportRequestFirst() {
    ...
    return (
        ...
        <div className="flex bg-[#EDEFF9] w-[1510px] h-[780px]  overflow-hidden">
            ...
            <div className="bg-[#FFFFFF] w-[1230px] h-[750px] mt-[20px] ml-[20px] rounded-[10px]  ">
                <div className="p-4">
                ...
                <div className="">
                    ...
                    <div>
                        ...
                        <div className="top-[698px] absolute right-0  bottom-0 left-[1166px] bg-white shadow-md rounded-lg p-2 flex items-center border border-[#D9D9D9] h-[70px] w-[332px]">
