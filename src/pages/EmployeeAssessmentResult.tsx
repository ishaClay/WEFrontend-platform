                                            ...
                                            <div className="border border-solid border-[#D9D9D9]  md:w-[1150px]  md:h-[164px] rounded-[10.06px] flex flex-col hover:border-[#64A70B] focus:border-[#64A70B]">
                                                ...
                                                <div className="flex flex-col md:flex-row h-auto md:h-32">
                                                    <div className="flex flex-col items-center md:items-start">
                                                        ...
                                                        <div className="ml-0 md:ml-8 mt-4 text-[#1D2026] font-Calibri">Environmental</div>
                                                    </div>
                                                    ...
                                                    <div className="mt-4 md:mt-8">
                                                        <button className="bg-[#64A70B] text-white py-2 px-4 rounded-md flex justify-between h-[40px] w-[150px] items-center ml-4 md:ml-4">
                                                    ...
                                                    <div className="w-full md:w-[543px] h-auto md:h-[110px] mt-4 md:mt-0">
                                                        ...
                                                        <div>
                                                            <ul className="list-disc ml-4 md:ml-6 md:text-[14px] text-[#8C94A3]">
                                                                <li>Systematically link sustainability efforts to economic outcomes, continuously tracking and optimizing impact.</li>
                                                                <li>Integrate risk management into business strategy, assessing and mitigating economic implications comprehensively.</li>
                                                                <a href="#" className="text-blue-500 text-[10px] md:text-[12px] hover:underline">View More</a>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <div className="mt-4 md:mt-8">
                                            ...
                                            <div className="border border-solid border-[#D9D9D9] w-full md:w-[1150px] h-auto md:h-[164px] rounded-[10.06px] flex flex-col hover:border-[#64A70B] focus:border-[#64A70B]">
                                                ...
                                                <div className="flex flex-col md:flex-row h-auto md:h-32">
                                                    ...
                                                    <div className="w-full md:w-[543px] h-auto md:h-[110px] mt-4 md:mt-0">
                                                        ...
                                                        <div>
                                                            <ul className="list-disc ml-6 text-[14px] text-[#8C94A3]">
                                                                <li>Expand R&D investments to include long-term projects aimed at sustainable technologies.</li>
                                                                <li>Implement circular economy initiatives in specific areas, working towards full integration.</li>
                                                                <a href="#" className="text-blue-500 text-[12px] hover:underline">View More</a>
                                                            </ul>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className="border border-solid border-[#D9D9D9] w-full md:w-[1150px] h-auto md:h-[164px] rounded-[10.06px] flex flex-col hover:border-[#64A70B] focus:border-[#64A70B]">
                                                ...
                                                <div className="flex flex-col md:flex-row h-auto md:h-32">
                                                    ...
                                                    <div className="w-full md:w-[543px] h-auto md:h-[110px] mt-4 md:mt-0">
                                                        ...
                                                        <div>
                                                            <ul className="list-disc ml-6 text-[14px] text-[#8C94A3]">
                                                                <li>Drive and influence systemic changes by leading collaborative sustainability efforts.</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <div className="mt-4 md:mt-8">
