        ...
        <div className="flex flex-col md:flex-row bg-[#EDEFF9] w-full md:w-[1510px] h-full md:h-[1740px] overflow-hidden relative">
            ...
            <div className="bg-[#FFFFFF] w-full lg:w-[1230px] h-auto lg:h-[1680px] mt-[20px] lg:ml-[20px] rounded-[10px] ">
                ...
                <div className="flex flex-col space-y-4 p-4">
                    {[...Array(6)].map((_, i) => (
                        <div key={i} className="flex flex-col md:flex-row border border-solid border-[#D9D9D9] rounded p-4">
                            ...
                            <div className="flex flex-col justify-between mt-4 md:mt-0 md:ml-4">
                                <div>
                                    ...
                                    <div className="flex gap-2 mt-3 flex-wrap">
                                        <button className="bg-[#FFD56A] text-[#3A3A3A] rounded-full h-[28px] px-4">Environmental</button>
                                        <button className="bg-[#FFD56A] text-[#3A3A3A] rounded-full h-[28px] px-4">Governance</button>
                                        <button className="bg-[#D6F5AC] text-[#3A3A3A] rounded-full h-[28px] px-4">Social</button>
                                    </div>
