                                        ...
                                        <div className="flex flex-col ">
                                            ...
                                            <div>
                                                <div className="flex items-center">
                                                    ...
                                                    <span className="text-[#8C94A3] font-semibold text-sm mr-2 ml-1">4.5</span>
                                            ...
                                            <div className="flex ">
                                                <div className="h-[44px] w-[550px] mt-[16px]" style={{ fontFamily: 'Inter', fontSize: '16px', fontWeight: 700, lineHeight: '22px', textAlign: 'left' }}>
                                            ...
                                            <div className="flex mt-[16px] leading-[19px]">
                                                <p className="text-[16px]">Trainer: Trainer Name, Trainer Name</p>
                                            </div>
                                ...
                                <AccordionContent>
                                    <div className="w-full h-[auto] mt-[20px] border gray rounded-[10px]">
                                        <div className="border-b gray h-[70px] flex  items-center pl-[20px]">
                                            <h3 className="font-calibri text-[16px] font-[700]">Prime Infotech</h3>
                                        </div>
                                        <div className="border-b gray w-full h-[70px] flex justify-between items-center p-[20px]">
                                            <div className="flex items-center gap-[5px]">
                                                ...
                                                <Progress className="ml-[78px]" color="#58BA66" value={33} />
                                            </div>

                                            <div className="flex gap-[14px]">
                                                <div className="flex gap-[8px]">
                                                    <img className="w-[16px] h-[16px]" src="../assets/img/Group 1000001820 (1).png" />
                                                    <span className="text-[#58BA66]">Completed</span>
                                                </div>
                                                <div className="flex gap-[8px]">
                                                    <img className="w-[16px] h-[16px]" src="../assets/img/Group 1000001820 (1).png" />
                                                    <span className="text-[#58BA66]">Certificate Issued</span>
                                                </div>
                                                <div className="flex gap-[8px]">
                                                    <p>Score: </p>
                                                    <span>10/50</span>
                                        ...
                                        <div className="border-b gray w-full h-[70px] flex justify-between items-center p-[20px]">
                                            ...
                                            <div className="flex gap-[28px] items-center">
                                                ...
                                                <div className="flex gap-[8px]">
                                                    <Button className="bg-[white] text-[#00778B] border border-[#00778B]">Allocate Certificate</Button>
                                                </div>
                                                <div className="flex gap-[8px]">
                                                            ...
                                                            <div className="py-4">
                                                                <div className="w-full h-[auto] border gray rounded-[10px] p-[15px]">
                                                                    ...
                                                                    <div className="flex gap-[15px]">
                                                                        <h3 className="text-[#606060] font-[700]">Question: 1</h3>
                                                                        <h3 className="text-[#606060] font-[700]">Points: 5</h3>
                                                                    </div>
                                                                    ...
                                                                    <h3 className="mt-[12px] text-[#606060] font-[700]">Answer</h3>
                                                                    <h3 className="mt-[10px]">This is the second item's accordion body. It is hidden by default.</h3>
                                                                    <h3 className="mt-[12px] text-[#606060] font-[700]">Keywords (Matched 40, Unmatched 10) </h3>

                                                                    <div className="flex gap-[15px]">
                                                                        <a className="w-[104px] h-[32px] bg-[#D9D9D9] rounded-[30%]">Keyword one</a>
                                                                    </div>
                                        ...
                                        <div className="border-b gray w-full h-[70px] flex justify-between items-center p-[20px]">
                                            ...
                                            <div className="flex gap-[28px] items-center">
                                                ...
                                                <div className="flex gap-[8px]">
                                                    <Button disabled className="bg-[white] text-[#00778B] border border-[#00778B]">Allocate Certificate</Button>
                                                </div>
                                                <div className="flex gap-[8px]">
                                                    <Button disabled className="bg-[#00778B] text-[white] border border-[#00778B]">Evaluate</Button>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="border-b gray w-full h-[70px] flex justify-between items-center p-[20px]">
                                        ...
                                        <div className="border-b gray w-full h-[70px] flex justify-between items-center p-[20px]">
                                            <div className="flex items-center gap-[15px]">
                                                <Button className="bg-[white] hover:bg-[#b0afaf]  w-[142px] h-[36px] text-[black] border border-black">Live Season 1</Button>
                                                <Button className="bg-[white] hover:bg-[#b0afaf]  w-[142px] h-[36px] text-[black] border border-black">Live Season 2</Button>
                                                <Button className="bg-[white] hover:bg-[#b0afaf] w-[142px] h-[36px] text-[black] border border-black">Live Season 3</Button>
                                            </div>
                                        </div>
                                    </div>
                                </AccordionContent>
