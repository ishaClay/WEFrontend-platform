...
function EmployeeSupportRequestSecond() {
    ...
    return (
        ...
        <div className="flex flex-col md:flex-row bg-[#EDEFF9] w-full md:w-[1510px] h-full md:h-[1170px] overflow-hidden relative">
            {sidebarOpen && (
            ...
            <div className="bg-[#FFFFFF] w-full lg:w-[1230px] h-auto lg:h-[1115px] mt-[20px] lg:ml-[20px] rounded-[10px] ">
                <div className="p-4">
                    <div className="pb-4 w-full lg:w-[1195px] h-[50px] bg-[#FFFFFF] border-b border-[#F1F1F1] rounded-t-[10px] flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <span className="text-[18px] ml-1 font-semibold">
                                My Courses<span className="hidden md:inline text-[18px] font-semibold text-[#00778B]"> / Support request</span>
                            </span>
                        </div>
                ...
                <div className="">
                    ...
                    <div>
                        <div className="flex flex-col md:flex-row items-center p-4">
                            ...
                            <button className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded mt-4 md:mt-0 md:ml-auto">
                                SUBMIT
                            </button>
                        </div>
