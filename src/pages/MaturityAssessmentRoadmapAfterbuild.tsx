							...
							<button
								className={`${
									activeTab === "Assessment Result"
										? "  text-[#00778B]  font-bold border-b border-[#00778B]"
										: " text-[#000000] "
							...
							{activeTab === "Roadmap" && (
								<div className="flex flex-col">
									<div className="flex relative ">
										<div className="flex flex-col  ">
											<div className="ml-[20px] text-[#1D2026] mt-4 text-center font-Calibri rounded-full bg-opacity-70 bg-[#D9D9D9] h-[32px] w-[32px] flex items-center justify-center">
												1
											</div>
										...
										<div className="flex flex-col ml-[360px] ">
											<div className=" text-[#1D2026] mt-4 text-center font-Calibri rounded-full bg-opacity-70 bg-[#D9D9D9] h-[30px] w-[30px] flex items-center justify-center">
												2
											</div>
											<div className="w-[240px] ml-[-50px]">
												Define Action Item
											</div>
										</div>
