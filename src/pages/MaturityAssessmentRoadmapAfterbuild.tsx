        ...
        <div className="bg-[#FFFFFF] w-[1250px] h-[1950px] m-[12px] rounded-[10px] ">
          <div className="w-[1250px] h-[60px] bg-[#FFFFFF] border-b border-[#D9D9D9] rounded-t-[10px]">
            <div className="pt-[10px]">
              <button
                className={`${activeTab === 'Assessment Result' ? 'text-[#00778B] font-semibold border-b border-[#00778B]' : 'text-[#000000]'} py-2 px-4 text-[16px] h-[49px]`}
                onClick={() => handleTabChange('Assessment Result')}
              >
                Assessment Result
              </button>
              <button
                className={`${activeTab === 'Roadmap' ? 'text-[#00778B] font-semibold border-b border-[#00778B]' : 'text-[#000000]'} py-2 px-4 text-[16px] h-[49px]`}
              ...
              {activeTab === 'Roadmap' &&
                <div className="flex flex-col">
                  <div className="flex relative">
                    ...
                    <div className="absolute top-3 border-1 border border-[#D9D9D9] w-[548px] mt-5 ml-[52px]"></div>
                    ...
                    <div className="absolute top-3 border-1 border border-[#D9D9D9] w-[550px] mt-5 ml-[630px]"></div>
                    ...
                    <div className="flex w-full h-[112px] border-b border-l border-r border-solid border-[#D9D9D9]">
                      <div className="h-[112px] w-[900px] pl-4 flex">
                        <div className="flex flex-col bg-">
                          <div>
                            <p className="pt-2 text-[#000000] pl-3">Lead in energy efficiency through continuous optimization and strategic energy management.</p>
                          </div>
                          ...
                          <div>
                            <div className="flex gap-2 pl-3 pt-2">
                              ...
                              <div>
                                <p className="text-sm text-[#666666]">Date:<span className="text-black">2nd March, 2024 - 2nd March, 2024</span></p>
                              </div>
                            </div>
                          </div>
                        </div>
