    ...
    <div className="fixed inset-0 flex justify-center items-center bg-gray-900 bg-opacity-50">
      <div className="bg-white rounded-lg p-6 h-[640px] w-[800px] ">
        ...
        <div className="flex items-center mt-[10px]">
          <h2 className="text-[15px] mb-2 ml-[px] font-bold">Invite Team Member</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className='flex'>
            <div className="mr-4">
              ...
              <input
                ...
                className="border border-[#D9D9D9] rounded px-3 py-2 w-[370px] placeholder-[#A3A3A3]"
          ...
          <div>
            <label htmlFor="email" className="block mb-1">Team Member Email</label>
            <input
              type="email"
              id="email"
              name="email"
              ...
              className="border border-[#D9D9D9] rounded px-3 py-2 w-full placeholder-[#A3A3A3]"
              required
            />
          </div>
          <div>
            <label htmlFor="details" className="block mb-1">Invitation Details</label>
            <textarea
              id="details"
              name="details"
          ...
          <button type="submit" className="bg-green-500 text-white py-2 px-4 rounded hover:bg-green-600 ml-[630px]">Send Invite</button>
        </form>
      </div>
    </div>
  );
