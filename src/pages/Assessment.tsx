          ...
          <div className="w-full lg:col-span-1 col-span-full lg:block flex items-center justify-center">
            <div className="lg:my-[100px] sm:my-[60px] my-[30px] xl:mb-0">
              <div className="flex items-end gap-x-[14px]">
                <h3 className="font-font-droid sm:text-[24px] text-[22px] font-[400]">
              ...
              <p className="sm:max-w-[525px] w-full text-[16px] font-[400] font-font-droid text-[#332626] leading-[17px] mt-[22px]">
                Find how you score across 6 sustainability pillars with 30
                questions.
              </p>

              <h2 className="font-[700] sm:text-[24px] text-[22px] font-font-droid lg:mt-[63px] sm:mt-[40px] mt-[25px]">
                The 6 sustainability pillars you’ll be assessed by:
              </h2>
              {/* flex-col 2xl:flex-row gap-8 2xl: */}
              <div className="font-droid flex items-center justify-between">
                <div>
                  <div className="flex 2xl:gap-x-[42px] gap-x-[24px] items-center mt-[24px]">
                    <div className="flex flex-col gap-y-[16px]">
                      <div className="flex gap-x-[10px] items-center font-font-droid">
                        <img
              ...
              <PrimaryButton
                ...
                name="Start Now"
                className="sm:w-[266px] w-[200px] primary-background  sm:h-[55px] h-[50px] md:mt-[57px] sm:mt-[45px] mt-[35px] sm:text-[20px] text-lg !font-droid"
              />
            </div>
          </div>
        </div>
