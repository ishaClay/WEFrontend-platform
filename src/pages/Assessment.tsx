					...
					<div className="w-[600px] h-[524px] ">
						<div className="mt-[140px] ml-[78px]">
							...
							<p className="w-[525px]  text-[16px] font-[400] font-[calibri] text-[#332626] leading-[17px] mt-[22px]">
								Steer through 30 pivotal questions under 6 sustainability
								pillars to chart your company's course towards environmental
								stewardship.
								<br></br>
								<br></br>
							...
							<p className="w-[685px] font-[400] text-[16px] mt-[24px]">
								Embarking on this assessment voyage sets your sails towards
								market distinction through sustainability. It's your sextant to
								gauge and refine your green practices, ensuring your journey not
								only charts a course for success but also for a healthier planet
							</p>
