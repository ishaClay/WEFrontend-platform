                    ...
                    <div className="pb-4 w-full lg:w-[1195px] h-[50px] bg-[#FFFFFF] border-b border-[#F1F1F1] rounded-t-[10px] flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <span className="text-[18px] ml-1 font-semibold">
                                My Courses<span className="hidden md:inline text-[18px] font-semibold text-[#00778B]"> / Social</span>
                            </span>
                        </div>
                ...
                <div className="mt-4">
                    <div className="flex flex-col md:flex-row justify-between border-b">
                        <div className="flex flex-col md:flex-row">
                            <button
                                className={`py-2 px-4 text-[14px] md:text-[16px] text-center border-b-2 ${activeTab === "tab1" ? "border-[#00778B] text-[#00778B]" : "border-transparent"
                                    } focus:outline-none`}
                            ...
                            <button
                                className={`py-2 px-4 text-[14px] md:text-[16px] text-center border-b-2 md:ml-4 ${activeTab === "tab2" ? "border-[#00778B] text-[#00778B]" : "border-transparent"
                                    } focus:outline-none`}
                        ...
                        <div className="relative mt-2 md:mt-0">
                            <button
                                className="flex items-center justify-center py-2 px-4 text-[14px] md:text-[16px] text-center border-b-2 md:mr-6 border-[#00778B] text-[#00778B] focus:outline-none"
                            >
                                        ...
                                        {chapters.map((chapter, index) => (
                                            <div key={index} className="flex items-center">
                                                <div className="relative">
                                                    ...
                                                    <div
                                                        className={`ml-4 w-6 h-6 rounded-full ${chapter.isActive
                                ...
                                <div className="flex flex-col md:flex-row border-b-2 border-[#D2D2D2] h-auto md:h-[81px]  bg-[#FAFAFA] ml-4 md:ml-4 overflow-x-auto md:w-[1205px]">
                                    <div className="flex gap-6 ml-4 md:ml-4 border-r-2 border-[#D2D2D2]  md:w-[150px] h-auto md:h-[81px]">
                                        ...
                                        <div className="flex flex-col items-center border-none cursor-pointer mt-4">
                                            ...
                                            <span className="text-sm text-gray-800 mt-2 text-[12px]">File</span>
                                        </div>
                                        <button className="flex flex-col items-center border-none cursor-pointer mt-4">
                                            <div className="flex items-center">
                                    ...
                                    <div className="ml-2 md:ml-0 border-r-2 border-[#D2D2D2] md:w-[50px]">
                                        <button className="flex flex-col items-center border-none cursor-pointer mt-4">
                                            ...
                                            <span className="text-[10px]  md:ml-3 text-[#545454]">Find</span>
                                        </button>
                                        <span className="text-sm text-gray-800 mt-2 md:ml-3 md:text-[12px]">Find</span>
                                    </div>
                                    ...
                                    <div className="border-r-2 border-[#D2D2D2]  md:w-[180px]">
                                        ...
                                        <p className="text-[12px] text-[#000000] md:ml-[70px] ml-[185px] mt-2">Zoom In</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex">
                                    <div className="">
                                        <div className="flex ml-4 h-[40px]  md:w-[250px] bg-[#FAFAFA] border-b-2 border-r-2 border-[#D2D2D2]">
                                            <button className="focus:outline-none ml-auto md:ml-16">
                                                <LuMenuSquare className="h-6 w-6" />
                                            </button>
                                            <button className="focus:outline-none ml-auto md:ml-[80px] border-b-2 border-[#000000]">
