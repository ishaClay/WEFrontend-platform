...
function CourseEmrolledToEmployeePopup() {
    const [employees, setEmployees] = useState([
        { id: 1, name: 'Employee Name1', selected: false, imageUrl: '/public/assets/img/face1.jpg' },
        { id: 2, name: 'Employee Name2', selected: false, imageUrl: '/public/assets/img/face2.jpg' },
        { id: 3, name: 'Employee Name3', selected: false, imageUrl: '/public/assets/img/face3.jpg' },
        { id: 4, name: 'Employee Name4', selected: false, imageUrl: '/public/assets/img/face1.jpg' },
            ...
            <div className="bg-white rounded-lg p-6 h-[640px] w-[800px] ">
                <div className=' border-b-2 pb-[10px]'>
                    ...
                    <div className="flex overflow-hidden rounded">
                        ...
                        <div className="flex flex-col ml-1 ml-[15px]">
                            <div className="flex items-center justify-between">
                                <span className="text-[#1D2026] text-xl font-bold">
                                    Certificate in the Sustainable Development Goals, Partnership, People, Planet and Prosperit
                                </span>
                ...
                <div className="flex items-center mt-[20px]">
                    ...
                    <div className="ml-4 flex items-center ml-[510px]">
                        <label className="font-bold mr-[5px]">Select All</label>
                        <input type="checkbox" className="h-[18px] w-[18px] rounded ml-[5px] mr-[5px]" onChange={handleSelectAll} />
                ...
                <ScrollArea className="h-[300px] w-[755px] rounded-md ">
                    <div className="p-4 ">
                        {employees.map(employee => (
                            <div key={employee.id} className="flex items-center mb-2 border-b pb-2 border-[#D9D9D9]">
                                <img src={employee.imageUrl} className="w-10 h-10 rounded-full border-[#D9D9D9]  border-2 mr-2 " />
                ...
                <button className="bg-[#00778B] text-white px-4 py-2 rounded mr-[495px] mt-[5px]" onClick={handleInviteEmployee}>Invite Employee</button>
                <button className="bg-[#58BA66] text-white px-4  rounded w-[100px] h-[40px] " onClick={handleAllocate}>Allocate</button>
