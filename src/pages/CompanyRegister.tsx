...
function CompanyRegister() {
    ...
    const schema = z.object({
        ...
        averageNumberOfEmployees: z.string().min(1, { message: "Average Number Of Employees is required" }),
        sector: z.string().min(1, { message: "Sector is required" }),
        parentCompanyAddress:z.string().min(1, { message: "Parent Company Address is required" }),
        parentCompanyName: z.string().min(1, { message: "Parent Company Name is required" }),
        email: z.string().min(1, { message: "Email is required" }),   
        parentCompanyCounty: z.string().min(1, { message: "Parent Company County is required" }),
                            ...
                            <div className="flex flex-wrap gap-x-[100px] sm:gap-x-[40px] gap-y-[30px] mt-[32px] justify-center">
                                ...
                                <div>
                                    ...
                                    {errors.averageNumberOfEmployees && (
                                        <ErrorMessage message={errors.averageNumberOfEmployees.message as string} />
                                    )}
                                </div>
                                <div>
                                    <InputWithLable
                                ...
                                <div>
                                    ...
                                    {errors.parentCompanyAddress && (
                                        <ErrorMessage message={errors.parentCompanyAddress.message as string} />
									)}
                                </div>
                                ...
                                <div>
                                    ...
                                    {errors.parentCompanyName && (
                                        <ErrorMessage message={errors.parentCompanyName.message as string} />
                                    )}
                                </div>
                                <div>
                                    <InputWithLable
                                ...
                                <div>
                                    ...
                                    {errors.parentCompanyCounty && (
                                        <ErrorMessage message={errors.parentCompanyCounty.message as string} />
                                    )}
                                </div>
