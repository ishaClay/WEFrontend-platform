            ...
            <div className="flex flex-col">
                ...
                <div className="bg-[#FFFFFF] w-[1250px] h-[1469px] m-[12px] rounded-t-[10px]">
                    ...
                    <Tabs defaultValue="account" className="w-[400px]">
                        ...
                        <TabsContent value="Feedback">Make changes to your account here.</TabsContent>
                        <TabsContent value="Forum">
                            <div className="m-[50px] border h-[310px] border-[#D9D9D9] rounded-[5px] p-[23px]">
                                <div className=" flex gap-[10px]">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-inter text-[12px] text-[#5B5B5B]">Trainer Admin</p>
                                    </div>
                                </div>
                            ...
                            <div className="m-[50px] border h-[1022px] border-[#D9D9D9] rounded-[5px] p-[23px]">
                                <div className=" flex gap-[10px]">
                                    ...
                                    <div>
                                        <h3 className="font-calibri ">User Name Here</h3>
                                        <p className="font-inter text-[12px] text-[#5B5B5B]">Trainer Admin 2 Day's ago</p>
                                    </div>
                                </div>

                                <h3 className="mt-[18px]"> How long does it take for a wind turbine to balance out the carbon emissions caused by its production?</h3>
                                ...
                                <div className="flex gap-[16px] mt-[21px]">
                                    ...
                                    <div className="w-full h-[auto] bg-[#F5F7FF] p-[15px] rounded-[15px]">
                                        <h3 className="font-inter text-[14px] font-[600]">Comment Person Name</h3>
                                        <p className="font-inter text-[12px] mt-[6px]">Compared to other energy sources, the installation and running costs of wind power facilities are very low. However, building a wind farm does produce a certain amount of carbon emissions as well as other greenhouse gases. Research has shown that an average wind turbine balances out its carbon footprint within the first 5-7 months and generates zero-emission electricity for the rest of its 30 year lifespan. With technological improvements and the electrification of transport, CO2 emissions are expected to be reduced even further.</p>
                                    </div>
                                </div>
                                <div className="flex gap-[23px] ml-[60px] mt-[10px]">
                                    <p className="text-[#606060] font-inter text-[12px]">Few minutes ago</p>
                                    <a className="font-inter text-[12px] cursor-pointer" onClick={() => handleReplyClick(1)}>Reply</a>
                                </div>
                                ...
                                {replyMode === 1 && (
                                    <div className="flex gap-[16px] mt-[21px] ml-[60px]">
                                        ...
                                        <div className="w-full relative">
                                            <textarea className="w-full h-[100px] p-[10px] bg-[#F5F7FF] rounded-[15px]" placeholder="Reply to Comment Person Name..." > 
                                        
                                         </textarea>
                                            <Button className="absolute bottom-[30px] right-8 w-[70px] h-[38px] bg-[#42A7C3]">Post</Button>
                                        </div>
