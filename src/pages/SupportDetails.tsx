...
function SupportDetails() {
    ...
    const handleTicketStatusChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
        setTicketStatus(e.target.value);
    };

    const handleTicketReplyChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
                ...
                <div className="bg-[#FFFFFF] w-[1250px] h-[1490px] m-[12px] rounded-t-[10px]">
                    ...
                    <div className="flex justify-between">
                        <div className="flex p-6">
                            ...
                            <div className="flex flex-col">
                                <span className="text-[16px]  text-[#000000]">Danila Raffel</span>
                    ...
                    <div className="flex flex-col gap-4 p-4 border w-[1210px] ml-[20px] mt-[10px] rounded">
                        <div className="text-[16px] text-[#A3A3A3] font-semibold">Ticket Subject</div>
                        <div className="text-black">How to customize the template?</div>

                        <div className="text-[16px] font-semibold text-[#A3A3A3]">Ticket Details</div>
                        ...
                        <div className="flex items-center mt-[20px] ">
                            ...
                            <div className="text-gray-700 ml-[20px]">pdf file attachment.pdf</div>
                        </div>
                    </div>
                    ...
                    <div className="p-4   rounded-lg">
                        <div className="flex flex-wrap -mx-2">
                            ...
                            <div className="w-full md:w-1/2 px-2 mb-4">
                                <label htmlFor="ticketStatus" className="block text-sm font-medium text-gray-700">Ticket Status</label>
                                <select
                                    id="ticketStatus"
                                    name="ticketStatus"
                                    value={ticketStatus}
                                    ...
                                    className="mt-1 block w-full py-2 px-3 border border-[#D9D9D9]   rounded-md  "
                                >
                                    <option value="Open" className="text-red-500">Open</option>
                                    <option value="Closed">Closed</option>
                                </select>
                            </div>
                        </div>
                        <div>
                            <label htmlFor="ticketReply" className="block text-sm font-medium text-gray-700">Ticket Reply</label>
                            <textarea
                                id="ticketReply"
                                name="ticketReply"
                                value={ticketReply}
                                ...
                                className="mt-1 block w-full h-32 py-2 px-3 border border-[#D9D9D9]  placeholder-[#A3A3A3]"
                            ></textarea>
                        </div>
                    </div>
