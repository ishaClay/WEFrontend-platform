        ...
        <div className="fixed inset-0 flex justify-center items-center bg-gray-900 bg-opacity-50">
            <div className="bg-white rounded-lg p-6 h-[640px] w-[800px] ">
                ...
                <div className="flex items-center mt-[20px]">
                    ...
                    <div className="ml-4 flex items-center ml-[524px]">
                ...
                <button className="bg-[#58BA66] text-white px-4 py-2 rounded ml-[610px] mt-[5px]" onClick={handleInviteEmployee}>Edit Allocation</button>
