    ...
    return (
        <div className='container flex mx-auto'>
            <div className='relative'>
                ...
                <img className='absolute top-[142px] left-[160px]' src='../assets/img/Multipurpose.png' />
                <img className='absolute top-[363px] left-[240px] w-[318px] h-[496px]' src='../assets/img/pngwing.png' />
            </div>
            ...
            <div className='w-[694px]'>
                ...
                <div className='w-[505px] h-[450px] relative mt-[142px] ml-[91px]'>
                    ...
                    <p className='w-[446px] h-[40px] text-[16px] font-[400]'>Just click on your role “Company or Trainer” and let's drive into your journey!</p>
                    <div>
                        <RegisterButton />
                    </div>
                </div>
